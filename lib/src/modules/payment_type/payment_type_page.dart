  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      final statusDisposer = reaction((_) => controller.status, (status) {
        switch (status) {
          case PaymentTypeSateStatus.initial:
            break;
          case PaymentTypeSateStatus.loading:
            showLoader();
            break;
          case PaymentTypeSateStatus.loaded:
            hideLoader();
            break;
          case PaymentTypeSateStatus.error:
            hideLoader();
            showError(
              controller.errorMessage ?? 'Erro ao buscar formas de pagamentos',
            );
            break;
          case PaymentTypeSateStatus.showAddOrUpdatePayment:
            hideLoader();
            showAddOrUpdatePayment();
            break;
          case PaymentTypeSateStatus.saved:
          hideLoader();
