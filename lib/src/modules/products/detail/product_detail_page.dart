...
class _ProductDetailPageState extends State<ProductDetailPage>
  ...
  final controller = Modular.get<ProductDetailPage>();
      ...
      reaction((_) => controller.status, (status) {
        switch (status) {
          ...
          case ProductDetailStateStatus.loaded:
            ...
            descriptionEC.text = model.descreption;
            hideLoader();
            break;
        ...
        child: Form(
          ...
          child: Column(
            children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      children: [
                        TextFormField(
                          validator: Validatorless.required('Nome obrogatório'),
                          controller: nameEC,
                          decoration:
              ...
              TextFormField(
                validator: Validatorless.required('Nome obrogatória'),
                            ...
                            showDialog(
                              ...
                              builder: (context) {
                                return AlertDialog(
                                  ...
                                  content: Text(
                                    'Confimar a exclusão do produto ${controller.productModel!.name}',
                                  ),
                                  actions: [
                                    TextButton(
                                      onPressed: () {
