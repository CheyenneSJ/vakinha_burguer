...
class ProductRepositoryImpl implements ProductRepository {
  ...
  Future<void> deleteProduct(int id) async {
    try {
      ...
      log('Erro ao dleetar produto', error: e, stackTrace: s);
  ...
  Future<ProductModel> getProduct(int id) async {
    try {
      ...
      log('Erro ao buscar produtos $id', error: e, stackTrace: s);
  ...
  Future<void> save(ProductModel productModel) async {
    try {
      ...
      throw RepositoryException(message: 'Erro ao dalvar produto');
    }
  }
